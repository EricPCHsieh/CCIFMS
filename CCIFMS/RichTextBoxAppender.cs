...
namespace CCIFMS
{
  ...
  /// <remarks>
  /// <para>
  /// RichTextBoxAppender appends log events to a specified RichTextBoxcontrol.
  /// It also allows the color, font and style of a specific type of messageto be set.
  /// </para>
  /// <para>
  ...
  public class RichTextBoxAppender : AppenderSkeleton
  {
    ...
    private void UpdateControl(LoggingEvent loggingEvent)
    {
      ...
      if (selectedStyle != null)
      {
        ...
        //if (loggingEvent.Level.ToString)
    ...
    /// <remarks>
    /// <para>This method sets the RichTextBox property of the MyRichTextBoxAppender 
    ...
    public class LevelTextStyle : LevelMappingEntry
    {
      ...
      public override void ActivateOptions()
      {
        ...
        {
          float size = _pointSize > 0.0f ? _pointSize : 10.0f;
          try
          {
